 ...
 *
 */
package org.amway.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AmwayFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AmwayFulfilmentProcessConstants.PARENT_PROCESS);
