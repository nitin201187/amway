 ...
 *
 */
package org.amway.fulfilmentprocess.test.jobs;
...
import org.amway.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AmwayFulfilmentProcessConstants.ORDER_PROCESS_NAME;
