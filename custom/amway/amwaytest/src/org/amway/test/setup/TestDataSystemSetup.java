...
import org.amway.test.constants.AmwayTestConstants;
import org.amway.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AmwayTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/amwaytest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/amwaytest/import/reviews.impex");
			...
			importImpexFile(context, "/amwaytest/import/cstickets.impex");
		}
	}
}
