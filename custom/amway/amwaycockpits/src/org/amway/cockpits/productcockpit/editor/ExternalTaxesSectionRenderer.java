 ...
 *
 */
package org.amway.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("amwaycockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("amwaycockpits.product.externalTaxes"));
