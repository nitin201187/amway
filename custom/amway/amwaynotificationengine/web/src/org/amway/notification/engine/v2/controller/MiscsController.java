...
import org.amway.notification.engine.order.data.CardTypeDataList;
import org.amway.notification.engine.storesession.data.CurrencyDataList;
import org.amway.notification.engine.storesession.data.LanguageDataList;
import org.amway.notification.engine.user.data.CountryDataList;
import org.amway.notification.engine.user.data.TitleDataList;
...
public class MiscsController extends BaseController
{
	...
	@ResponseBody
	@Secured(
	{ "ROLE_CLIENT", "ROLE_CUSTOMERGROUP" })
