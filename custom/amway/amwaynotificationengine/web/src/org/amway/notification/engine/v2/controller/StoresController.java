...
import org.amway.notification.engine.v2.helper.StoresHelper;
...
public class StoresController extends BaseController
{
	...
	/**
	 * Returns {@value org.amway.notification.engine.v2.controller.BaseController#HEADER_TOTAL_COUNT} header with the number of all store locations that are near the
