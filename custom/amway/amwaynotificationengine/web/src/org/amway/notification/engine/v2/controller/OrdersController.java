...
import org.amway.notification.engine.exceptions.PaymentAuthorizationException;
import org.amway.notification.engine.strategies.OrderCodeIdentificationStrategy;
import org.amway.notification.engine.v2.helper.OrdersHelper;
...
public class OrdersController extends BaseCommerceController
{
	...
	/**
	 * Returns {@value  org.amway.notification.engine.v2.controller.BaseController#HEADER_TOTAL_COUNT} header with a total number of results (orders history for all
