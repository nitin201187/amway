...
package amwaynotificationengine;
...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			"CronJob",
			org.amway.notification.engine.jalo.expressupdate.cron.ProductExpressUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			org.amway.notification.engine.jalo.expressupdate.cron.OrderStatusUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			org.amway.notification.engine.jalo.OldCartRemovalCronJob.class,
			null,
			false,
			null,
			false
